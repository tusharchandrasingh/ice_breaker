...
def scrape_linkedin_profile(linkedin_profile_url: str):
    ...
    # skip actual url and instead respond using a static json
    ...
    print("log: avoiding PROXYCURL for look up", linkedin_profile_url, "; instead return data from", harrison_chase_json)
